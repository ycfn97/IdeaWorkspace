 ...
 * Package: day03
 * ClassName: Window_Time
 *
 * @author 18729 created on date: 2020/11/18 15:44
 * @version 1.0
 * @since JDK 1.8
 */
public class Window_Time {
    public static void main(String[] args) throws Exception {
        ...
        tuple2TupleKeyedStream.timeWindow(Time.seconds(5)).reduce(new ReduceFunction<Tuple2<String, Integer>>() {
            @Override
