 ...
 * Package: day03
 * ClassName: Window_Offset
 *
 * @author 18729 created on date: 2020/11/18 16:24
 * @version 1.0
 * @since JDK 1.8
 */
public class Window_Offset {
    public static void main(String[] args) throws Exception {
        ...
        tuple2TupleKeyedStream.window(ProcessingTimeSessionWindows.withGap(Time.seconds(5))).reduce(new ReduceFunction<Tuple2<String, Integer>>() {
            @Override
